		...
		.service('getData',function  ($http) {
			//获取轮播图数据
				...
				this.getCaiNiXiHuan = function  () {
					return $http.jsonp('https://list.mogujie.com/search?cKey=h5-shopping&fcid=&pid=9750&searchTag=&sort=pop&page=1&_version=61&_=1498814598150&callback=JSON_CALLBACK')
				}
		})
